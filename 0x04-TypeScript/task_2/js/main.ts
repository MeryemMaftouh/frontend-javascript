...
const role = (e: Director | Teacher) => (e instanceof Director ? 'Director' : 'Teacher');

console.log(role(createEmployee(200)));    // Teacher
console.log(role(createEmployee(1000)));   // Director
console.log(role(createEmployee('$500'))); // Director
